    ...
    return (
      <ScrollView>
        <View style={style.container}>
          ...
          <View style={style.indentSection}>
            <View style={style.paragraph}>
              <Text style={style.mainText}>
                ...
                personal, non-commercial use on a single mobile or tablet device
                owned or otherwise controlled by you (“
                <Text style={style.boldText}>Mobile Device”</Text>) strictly in
            ...
            <View style={style.paragraph}>
              <Text style={style.mainText}>
                ...
                in or otherwise accessible through the Application, strictly in
                accordance with this Agreement and the Terms of Use applicable
                to such Content and Services as set forth in{' '}
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              2. <Text style={style.underline}>License Restrictions.</Text> You
              shall not:
            </Text>
          </View>
          <View style={style.indentSection}>
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              3. <Text style={style.underline}>Reservation of Rights.</Text> You
              acknowledge and agree that the Application is provided under
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              5. <Text style={style.underline}>Content and Services.</Text> The
              Application may provide you with access to Company's website
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              6. <Text style={style.underline}>Geographic Restrictions.</Text>{' '}
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              7. <Text style={style.underline}>Updates.</Text> Company may from
              time to time in its sole discretion develop and provide
              Application updates, which may include upgrades, bug fixes,
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              8. <Text style={style.underline}>Third-Party Materials.</Text> The
              Application may display, include, or make available third-party
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              9. <Text style={style.underline}>Term and Termination.</Text>
            </Text>
          </View>
          <View style={style.indentSection}>
            <View style={style.paragraph}>
              <Text style={style.mainText}>
                ...
                or Company as set forth in this{' '}
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              10. <Text style={style.underline}>Disclaimer of Warranties.</Text>{' '}
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              11. <Text style={style.underline}>Limitation of Liability.</Text>{' '}
          ...
          <View style={style.indentSection}>
            ...
            <View style={style.paragraph}>
              <Text style={style.mainText}>
                ...
                OUT OUT OF BREACH OF CONTRACT, TORT (INCLUDING NEGLIGENCE), OR
                ...
                LIABILITY SO SOME OR ALL OF THE ABOVE LIMITATIONS OF LIABILITY
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              12. <Text style={style.underline}>Indemnification.</Text> You
              agree to indemnify, defend, and hold harmless Company and its
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              13. <Text style={style.underline}>Export Regulation.</Text> The
              Application may be subject to US export control laws, including
              ...
              the Application to, or make the Application accessible from, any
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              14. <Text style={style.underline}>Severability.</Text> If any
              provision of this Agreement is illegal or unenforceable under
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              15. <Text style={style.underline}>Governing Law.</Text> This
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              17. <Text style={style.underline}>Entire Agreement.</Text> This
              Agreement, our Terms, and our Privacy Policies constitute the
          ...
          <View style={style.paragraph}>
            <Text style={style.mainText}>
              18. <Text style={style.underline}>Waiver.</Text> No failure to
              exercise, and no delay in exercising, on the part of either party,
              any right or any power hereunder shall operate as a waiver
              thereof, nor shall any single or partial exercise of any right or
              power hereunder preclude further exercise of that or any other
