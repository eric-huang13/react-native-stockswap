  ...
  posts: [
    {
      ...
      body: "An article from the newspaper that I thought was interesting. Let me know what you think.",
      username: 'hfields123',
      img:
    ...
    },
    {
      ...
      comments: 125,
      timestamp: '1 hour ago',
      body: "Here is a post that I created. Please read it and like it if it was helpful to you.",
      username: 'hfields123',
      img:
    ...
    },
    {
      ...
      comments: 15,
      timestamp: 29,
      body: "Doing some research on investing today. Here is my favorite article about trading stocks.",
      img:
  ...
  comments: [
    {
      ...
      userId: 1,
      body:
        "What a great post above. I really enjoyed reading it. Thanks",
      time: '3 hours ago',
      likes: 2,
      username: 'hfields123',
    },
    {
      ...
      userId: 2,
      body:
        "Awesome content. Thank you for sharing with everyone!",
      time: '2 hours ago',
      likes: 1,
      username: 'vcasey123',
    },
    {
      ...
      userId: 3,
      body:
        "Cool article! I love reading all of your posts.",
