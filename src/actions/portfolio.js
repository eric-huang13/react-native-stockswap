  ...
  export const fetchStockWeekPortfolio = (ticker) => {
    return (dispatch) => {
      ...
      axios
        ...
        .catch((error) =>
          dispatch({type: FETCHSTOCKWEEKPORTFOLIO_ERROR, payload: error.response}),
        );
    };
  };
  ...
  export const fetchStockMonthPortfolio = (ticker) => {
    return (dispatch) => {
      ...
      axios
        ...
        .catch((error) =>
          dispatch({type: FETCHSTOCKMONTHPORTFOLIO_ERROR, payload: error.response}),
        );
    };
  };
  ...
  export const fetchStockThreeMonthPortfolio = (ticker) => {
    return (dispatch) => {
      ...
      axios
        ...
        .catch((error) =>
          dispatch({type: FETCHSTOCKTHREEMONTHPORTFOLIO_ERROR, payload: error.response}),
        );
    };
  };
  ...
  export const fetchStockYearPortfolio = (ticker) => {
    return (dispatch) => {
      ...
      axios
        ...
        .catch((error) =>
          dispatch({type: FETCHSTOCKYEARPORTFOLIO_ERROR, payload: error.response}),
        );
    };
  };
